...
class FundContributorServiceTest extends TestCase
{
    ...
    public function testBuildContributorDataSubtractsAllocationsFromNetBalance(): void
    {
        ...
        $this->assertSame(3000, $data['TOTAL_CONTRIBUTED']);
        $this->assertSame(0, $data['TOTAL_REFUNDED']);
        $this->assertSame(750, $data['TOTAL_ALLOCATED']);
        $this->assertSame(2250, $data['NET_BALANCE']);
        $this->assertSame(3, $data['ALLOCATION_COUNT']);
        $this->assertSame('750', $data['TOTAL_ALLOCATED_FORMATTED']);
        $this->assertSame('2 250', $data['NET_BALANCE_FORMATTED']);
    }
